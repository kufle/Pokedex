...
import { AppliedFilterType, GenerationType, PokemonSpecies, TypesType } from "@/types/pokemonTypes";
import ActionSheet, { ActionSheetRef } from "react-native-actions-sheet";
import FilterBottomSheet from "@/components/FilterBottomSheet";
import { fonts } from "@/utils/fonts";
import Filter from "@/components/Filter";
import { buildPokemonQuery } from "@/apollo/queries/pokemonQueries";
...
export default function Index() {
  ...
  const {loading, data, error, fetchMore} = useQuery(buildPokemonQuery(appliedFilter), {
